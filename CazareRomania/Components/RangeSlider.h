...
@property(nonatomic, strong) IBOutlet UIImageView * _trackBackground;
@property (strong, nonatomic) IBOutlet UILabel *_pretulMinim;
@property (strong, nonatomic) IBOutlet UILabel *_pretulMaxim;
