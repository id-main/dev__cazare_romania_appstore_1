...
#define CALLOUT_HEIGHT 42 // ...and allow only for this exact height.
#define CALLOUT_DEFAULT_WIDTH 61 // default "I give up" width when we are asked to present in a space less than our min width
#define TITLE_MARGIN 13 // the title view's normal horizontal margin from the edges of our callout view
#define TITLE_TOP 7 // the top of the title view when no subtitle is present
#define TITLE_SUB_TOP 0 // the top of the title view when a subtitle IS present
#define TITLE_HEIGHT 17 // title height, fixed
#define SUBTITLE_TOP 27 // the top of the subtitle, when present
#define SUBTITLE_HEIGHT 11 // subtitle height, fixed
...
@synthesize totcontentul;
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
		self.backgroundColor = [UIColor clearColor];
        totcontentul = [[UIView alloc]init];
    }
    return self;
}
...
- (void)rebuildSubviews {
	...
	if (self.contentView) {
        ...
        totcontentul.frame = self.contentView.frame;
        [self addSubview:totcontentul];
        //ComNSLog(@"Johny was here");
        [self bringSubviewToFront:totcontentul];
	}
	else {
...
//    [self.rightAccessoryView pointInside:[self.rightAccessoryView convertPoint:point fromView:self] withEvent:nil];
    ...
    [self.totcontentul pointInside:[self.contentView convertPoint:point fromView:self] withEvent:nil] ||[self.rightAccessoryView pointInside:[self.rightAccessoryView convertPoint:point fromView:self] withEvent:nil];
...
//    [titleLabel pointInside:[titleLabel convertPoint:point fromView:self] withEvent:nil] ||
//    [subtitleLabel pointInside:[subtitleLabel convertPoint:point fromView:self] withEvent:nil];
    }
...
- (void)drawRect:(CGRect)rect {
	...
	// Color Declarations
	UIColor* fillBlack = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
...
//	UIColor* outerStrokeColor = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.35];
	UIColor* shadowBlack = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
	UIColor* glossBottom = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
	UIColor* glossTop = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
	UIColor* strokeColor = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
	UIColor* innerShadowColor = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
	UIColor* innerStrokeColor = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
	UIColor* outerStrokeColor = [UIColor colorWithRed: 40/255 green: 50/255 blue: 57/255 alpha: 1];
	...
	//// CoreGroup ////
	{
		...
		[fillBlack setFill];
        //*** modif
        //THIS IS JOHN MOD DO NOT TOUCH :)
//        UIColor *fillColor = [UIColor colorWithRed:47.0f/255.0f green:54.0f/255.0f blue:59.0f/255.0f alpha:1.0f];
//        [fillColor setFill];
//        UIColor *strokeColor = [UIColor colorWithRed:47.0f/255.0f green:54.0f/255.0f blue:59.0f/255.0f alpha:1.0f];
//        [strokeColor setStroke];
//        // This closes the copy of your drawing path.
//        [backgroundPath closePath];
//        // Stroke the path after filling it so that you can see the outline
//        [backgroundPath fill]; // this will fill a closed path
//        [backgroundPath stroke];
//        
        
//		*** original code just a line
        [backgroundPath fill];
...
//			[[UIColor grayColor] setFill];
            [[UIColor colorWithRed:47.0f/255.0f green:54.0f/255.0f blue:59.0f/255.0f alpha:1.0f] setFill];
